...
const finalPhotoUrls = [
    ...
    // Asegúrate de que esta lista contenga los nombres EXACTOS de tus 26 imágenes.
];
...
function loadPhotos() {
    ...
    finalPhotoUrls.forEach(fileName => {
        ...
        // CLAVE: Se añade el prefijo 'assets/' para que el navegador sepa dónde buscar el archivo.
